...
import com.myandroidremote.commands.AndroidRemoteCommandFactory;
...
public class C2DMReceiver extends C2DMBaseReceiver {
    ...
    public void onMessage(Context context, Intent intent) {
         ...
         */
    	AndroidRemoteCommand command = AndroidRemoteCommandFactory.parseC2DMMessage(context, intent);
    	if (command != null)
    		command.execute(context);
    	else
    		AndroidRemoteCommands.playNotificationSound(context);
    }
}
