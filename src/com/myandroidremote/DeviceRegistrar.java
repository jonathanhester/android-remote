...
import com.myandroidremote.client.MyRequestFactory;
import com.myandroidremote.client.MyRequestFactory.RegistrationInfoRequest;
import com.myandroidremote.shared.RegistrationInfoProxy;
...
public class DeviceRegistrar {
    ...
    public static void registerOrUnregister(final Context context,
        ...
        String deviceName = prefs.getString(Util.DEVICE_NAME, "Android");
        ...
        req.fire(new Receiver<Void>() {
            ...
            public void onSuccess(Void response) {
                ...
                String temp = deviceRegistrationId;
                if (register) {
                ...
                String deviceRegistrationID2 = settings.getString(Util.DEVICE_REGISTRATION_ID, null);
